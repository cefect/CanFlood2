...
from .dialog_main import Main_dialog


class Canflood_plugin:
    ...
    def initGui(self):
        ...
        icon_path = os.path.join(self.plugin_dir, 'img', 'logo_20210510_22x22.png')
        assert os.path.exists(icon_path), f'icon_path not found: {icon_path}'
        self.add_action(
            icon_path,
